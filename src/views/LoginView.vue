          ...
          <v-col cols="12" sm="8" md="6" lg="4" xl="3">
              ...
              <v-card-text class="pa-8">
                <v-form @submit.prevent="handleSubmit" ref="formRef">
                    ...
                    <v-window-item value="login">
                      <div class="mb-6">
                        ...
                        <div class="text-right">
                          <v-btn variant="text" size="small" @click="esqueceuSenha" class="text-primary">
                            Esqueceu a senha?
                          </v-btn>
                        </div>
                      </div>
                          ...
                          >
                            <template v-slot:label>
                              <div class="text-body-2">
                                Aceito os 
                                <a href="#" @click.prevent="abrirTermos" class="text-primary text-decoration-none">
                                  Termos de Uso
                                </a> 
                                e 
                                <a href="#" @click.prevent="abrirPrivacidade" class="text-primary text-decoration-none">
                  ...
                  <div class="text-center">
                    <v-btn variant="text" size="small" @click="abrirDemo" class="text-medium-emphasis">
            ...
            <div class="text-center mt-6">
              <div class="d-flex justify-center align-center mb-2">
                ...
                <span class="text-caption text-medium-emphasis">Seus dados estão seguros conosco</span>
              </div>
...
const registerPasswordRules = [
  ...
  v => /(?=.*[a-z])(?=.*[A-Z])(?=.*\d)/.test(v) || 'Senha deve conter ao menos: 1 minúscula, 1 maiúscula e 1 número'
]
...
const isFormValid = computed(() => {
  if (currentTab.value === 'login') {
    ...
    return (
      ...
      aceitaTermos.value &&
      nomeBarbearia.value.length >= 3 &&
      nomeProprietario.value.length >= 2 &&
      /.+@.+\..+/.test(email.value) &&
...
const enviarRecuperacaoSenha = async () => {
  ...
  try {
    await sendPasswordResetEmail(auth, emailRecuperacao.value)
