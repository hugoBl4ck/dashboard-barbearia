        ...
        <v-card v-else-if="plan" class="pa-md-4" elevation="2">
          ...
          <div class="text-center pa-6">
            <p class="text-h4 font-weight-bold">
              ...
              <span class="text-h6 font-weight-light text-medium-emphasis"
                >/{{ plan.priceInterval === 'month' ? 'mês' : 'ano' }}</span
              >
            </p>
          </div>
...
const PRICE_ID = 'price_1SAWXe0EW5UDH4CWX7Krt61i' // ⚠️ Substitua pelo seu Price ID real
